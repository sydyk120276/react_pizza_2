    ...
    <section className="header">
      <div className="header__container">
        <div className="header__items">
          <div className="header__items-logo logo">
          ...
          <Link to="/basket" className="header__items-basket baskets">
            <span className="baskets__sum">{sumPrice} ₽</span>
            <div className="baskets__line"></div>
            <div className="baskets__icon">
              <svg
                width="18"
                height="18"
                viewBox="0 0 18 18"
              ...
              <div className="baskets__icon-count">{sumAmount}</div>
            </div>
          </Link>
        </div>
      </div>
